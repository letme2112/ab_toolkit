...
### Обязательная структура CSV
- Минимум 2 колонки.
- Минимум 2 уникальных значения для контрольной и тестовой групп.
...
## В разработке
- Добавить функцию для бакетизации + т-тест
- Зашить фичу автоопределения стат критерия
